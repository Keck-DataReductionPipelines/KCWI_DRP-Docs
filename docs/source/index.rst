...
We are excited to announce the release version of 1.3.1 of the KCWI DRP!

Like previous verions, this version now with support for both the red and blue sides
...
* Reduced bit depth of NOSKYSUB frame from 64 bits to 32 bits
